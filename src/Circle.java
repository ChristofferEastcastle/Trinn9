...
public class Circle extends Shape {
    ...
    private MovablePoint middlePoint;
     ...
     */
    public Circle(int radius, Color color, boolean filled, MovablePoint middlePoint) {
        super(color,filled);
        this.radius = radius;
    ...
    public void moveUp(double distance) {
        middlePoint.moveUp(distance);
    }

    @Override
    public void moveDown(double distance) {
        middlePoint.moveDown(distance);
    }

    @Override
    public void moveRight(double distance) {
        middlePoint.moveRight(distance);
    }

    @Override
    public void moveLeft(double distance) {
        middlePoint.moveLeft(distance);
    }
}