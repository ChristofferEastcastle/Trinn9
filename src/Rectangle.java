...
public class Rectangle extends Shape {
    ...
    private MovablePoint bottomRightPoint;
     ...
     */
    Rectangle(double width, double length, Color color, boolean filled, MovablePoint topLeftPoint, MovablePoint bottomRightPoint) {
        super(color, filled);
        this.width = width;
        this.length = length;
    ...
    */
    ...
    public void moveUp(double distance) {
        topLeftPoint.moveUp(distance);
        bottomRightPoint.moveUp(distance);
    }

    @Override
    public void moveDown(double distance) {
        topLeftPoint.moveDown(distance);
        bottomRightPoint.moveDown(distance);
    }

    @Override
    public void moveRight(double distance) {
        topLeftPoint.moveRight(distance);
        bottomRightPoint.moveRight(distance);
    }

    @Override
    public void moveLeft(double distance) {
        topLeftPoint.moveLeft(distance);
        bottomRightPoint.moveLeft(distance);
    }
}